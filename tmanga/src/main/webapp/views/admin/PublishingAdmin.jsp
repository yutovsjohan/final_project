...
<body class="w3-light-grey">
	...
	<div class="w3-main" style="margin-left: 300px; margin-top: 43px;">
		...
		<button class="btn btn-success publishing" dataMode="add">Thêm nhà xuất bản</button>
		<hr>
								...
								<td>
									<c:choose>
										<c:when test="${PubCom.status == 0 }">
											<span class="showHidePC" dataId=${PubCom.id } action="0" style="font-size: 20px;"><i class="fa fa-eye-slash" title="Bấm để hiện lên trên trang web"></i></span>
										</c:when>
										<c:otherwise>
											<span class="showHidePC" dataId=${PubCom.id } action="1" style="font-size: 20px;"><i class="fa fa-eye" title="Bấm để ẩn trên trang web"></i></span>
										</c:otherwise>
									</c:choose>
								</td>
								<td><button class="btn btn-info publishing" dataId=${PubCom.id } dataMode="edit">Sửa</button></td>
								<td>
			...
			<ul class="pagination">
				<c:if test="${totalpage != 1 && totalpage != 0 }">
					<c:if test="${1 != pageselected }">
						<li><a href="pubcomAdmin?p=1" rel="next" style="border-radius:20px"> << </a></li>
						<li><a href="pubcomAdmin?p=${pageselected - 1}" rel="next"> < </a></li>
					</c:if>			
					...
					<c:if test="${totalpage != pageselected }">
						<li><a href="pubcomAdmin?p=${pageselected + 1}" rel="next"> > </a></li>
						<li><a href="pubcomAdmin?p=${totalpage}" rel="next" style="border-radius:20px"> >> </a></li>
					</c:if>	
